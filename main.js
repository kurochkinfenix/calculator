...
const   costsHouseServices = document.getElementById('costs-house-services'),
        costsEat = document.getElementById('costs-eat'),
        costsSport = document.getElementById('costs-sport'),
...
const countingAvailableMoney = () => {
    ...
    const totalCosts = strToNum(costsHouseServices) + strToNum(costsEat) + strToNum(costsSport) + strToNum(costsCredit);
